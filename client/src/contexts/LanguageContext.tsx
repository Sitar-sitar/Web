...
const copy = {
  ja: {
    ...
    records: "件", updated: "更新", cached: "キャッシュ", individualPriority: "個別優先度", sourceNotice: "キャラクター名・装備名・数値は公開ゲームデータに基づいて表示されます。",
  ...
  en: {
    ...
    records: "RECORDS", updated: "Updated", cached: "Cached", individualPriority: "INDIVIDUAL PRIORITY", sourceNotice: "Character names, equipment names, and values are shown from public game data.",
  ...
  "zh-CN": {
    ...
    records: "条", updated: "更新", cached: "缓存", individualPriority: "角色优先级", sourceNotice: "角色名、装备名和数值依据公开游戏数据展示。",
