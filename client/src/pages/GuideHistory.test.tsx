      ...
      guideHistory: {
        useQuery: () => ({
          ...
          data: {
            ...
            updateLedger: { total: 248, reviewed: 20, pending: 228, nextBatch: { id: 3, names: [{ name: "サンデー" }, { name: "ブートヒル" }] }, criteria: "test criteria" },
          },
        }),
      },
    },
...
describe("更新履歴の多言語表示", () => {
  ...
  it("保存済みの英語設定を復元し、中国語へ切り替える", () => {
    ...
    expect(screen.getByText("20 / 248 Reviewed")).toBeTruthy();
