      ...
      guideHistory: {
        useQuery: () => ({
          ...
          data: {
            ...
            updateLedger: { total: 248, reviewed: 90, pending: 158, nextBatch: { id: 10, names: [{ name: "ジェイド" }, { name: "ジェパード" }] }, criteria: "test criteria" },
          },
        }),
      },
    },
...
describe("更新履歴の多言語表示", () => {
  ...
  it("保存済みの英語設定を復元し、中国語へ切り替える", () => {
    ...
    expect(screen.getByText("90 / 248 Reviewed")).toBeTruthy();
